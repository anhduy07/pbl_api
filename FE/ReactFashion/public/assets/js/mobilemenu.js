! function (d) {
    ...
    function a() {
        !d(".akasha-menu-clone-wrap").length && 0 < d(".akasha-clone-mobile-menu").length && d("body").prepend('<div class="akasha-menu-clone-wrap"><div class="akasha-menu-panels-actions-wrap"><a class="akasha-menu-close-btn akasha-menu-close-panels" href="#">x</a></div><div class="akasha-menu-panels"></div></div>');
        Array();
